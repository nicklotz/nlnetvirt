...
def create_links(net, hosts, switches):
    """
    Create links between the hosts and switches in the network.
    
    This implementation connects each host to one switch in a round-robin fashion,
    which works regardless of the exact numbers of hosts and switches.
    """
    for i, host in enumerate(hosts):
        # Determine the switch to connect to in a round-robin fashion
